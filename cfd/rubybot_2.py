...
def on_ready(): 
	...
	loop.create_task(background_check_feed(loop, 'http://loreweaver-universe.tumblr.com/', client.get_channel('232218346999775232'), client.get_channel('243542820189765633'), 90))
